                ...
                <div class="col-sm-12">
                    <form id="set-page-visibility" action="/set-page-visibility" method="post">
                        ...
                        <div class="form-group">
                            <label style="color: black">Page visibility:</label>
                            <!-- TODO: learn to not shitcode xd -->
                            <div class="m-checkbox-inline">
                                <label for="edo-ani">
                                    <input style="color: black" class="radio_animated" id="edo-ani" type="radio" name="pageVisibility" <#if user.getPageVisibility().ordinal() == 2> checked=""</#if> value="VISIBLE_TO_ALL">All
                                </label>
                                <label for="edo-ani1">
                                    <input style="color: black" class="radio_animated" id="edo-ani1" type="radio" name="pageVisibility" <#if user.getPageVisibility().ordinal() == 1> checked=""</#if> value="VISIBLE_TO_USERS">Authorized
                                </label>
                                <label for="edo-ani2">
                                    <input style="color: black" class="radio_animated" id="edo-ani2" type="radio" name="pageVisibility" <#if user.getPageVisibility().ordinal() == 0> checked=""</#if> value="VISIBLE_TO_FRIENDS">Friends
                                </label>
                            </div>
                            <!-- shitcode -->
                        </div>
                    ...
                    <div class="btn-showcase">
                        <button form="set-page-visibility" style="color: black"
                                ...
                                <div class="blog-box blog-details">
                                    ...
                                    <div class="blog-details">
                                        <ul class="blog-social">
                                            ...
                                            <li class="digits"><i style="color: black" class="icofont icofont-thumbs-up"></i>02
                                            ...
                                            <li class="digits"><i style="color: black"
                                                ...
                                                <#if post.commentsEnabled>
                                                    <a style="color: black" href="/post-set-comments?postId=${post.getId()}&commentsEnabled=false">Disable</a>
                                                <#else>
                                                    <a style="color: black" href="/post-set-comments?postId=${post.getId()}&commentsEnabled=true">Enable</a>
                                                </#if>
                                            </li>
                                        </ul>
                                                ...
                                                <li >
                                                    <div class="media"><img class="align-self-center"
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p style="color: black">${comment.getCommentText()}</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </#list>
