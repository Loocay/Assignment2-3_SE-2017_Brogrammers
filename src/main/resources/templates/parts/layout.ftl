        ...
        <div class="page-main-header">
            <div class="main-header-right">
                <div class="main-header-left text-center">
                    <div class="logo-wrapper"><a href="/"><img src="/images/logo/logo.png" style ="width:100px; height:100px;" alt=""></a><h3>Cat Social Network</h3></div>
                </div>
                    ...
                    <ul class="iconMenu-bar custom-scrollbar">
                        <li><a class="bar-icons" href="javascript:void(0)">
                                <!--img(src='/images/menu/home.png' alt='')--><i
                                        class="pe-7s-home"></i><span style="color: black;">General    </span></a>
                            <ul class="iconbar-mainmenu custom-scrollbar">
                                <li class="iconbar-header" style="color: black;">Dashboard</li>
                                <li style="color: black;" ><a href="/">Blog</a></li>
                                <li style="color: black;"><a href="/add-post">Add blog</a></li>
                                <li style="color: black;"><a href="/users">Friends</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
